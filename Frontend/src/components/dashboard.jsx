...
function Dashboard() {
  ...
  const COLORS1 = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042', '#8884d8', '#82ca9d', '#ff7300'];
  const COLORS2 = ['#FFBB28', '#FF8042', '#8884d8', '#82ca9d', '#ff7300', '#0088FE', '#00C49F'];
  const totalBooks = bookData.reduce((total, entry) => total + entry.value, 0);
  const totalUsers = memebersData.reduce((total, entry) => total + entry.value, 0);
